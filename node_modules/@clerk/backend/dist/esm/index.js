...
import { deprecated as deprecated2 } from "@clerk/shared/deprecated";
...
var OrganizationAPI = class extends AbstractAPI {
  ...
  async getPendingOrganizationInvitationList(params) {
    deprecated2("getPendingOrganizationInvitationList", "Use `getOrganizationInvitationList` instead.");
    const { organizationId, limit, offset } = params;
    this.requireId(organizationId);
    return this.request({
      method: "GET",
...
function signedInAuthObject(sessionClaims, options, debugData) {
  ...
  if (apiKey) {
    deprecated4("apiKey", "Use `secretKey` instead.");
  }
